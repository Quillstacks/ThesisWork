...
In your proposal citations will all show up in the marginnotes like so~\cite{SchuteraBachelorThesis}.
This is achieved by use of the \texttt{\textbackslash cite\{\}} command. This also means that you should limit yourself and focus
on the most relevant works. Later in your thesis you will have a full reference section at the end of your document, and this section will be brimming with citations.

\vfill
\section{Objectives}\label{sec:Objectives}
\marginnote{\newthought{Key performance indicators} are the means to make your methods measurable. For every objective, answer one question first: how will I measure myself? Name the metrics and the targets that count as success, before you build. An objective you can not measure is a hope, not a goal.}
...
\section{Data and Groundtruth}\label{sec:Data}
\marginnote{\newthought{Groundtruth} is what you grade every result against. If it is wrong, every number you report afterwards is wrong too, so scrutinize it harder than your model.}
\newthought{Explain your data and groundtruth.} Before any method, make the reader understand what you will learn from and what you will measure against. For your data: where it comes from, how much there is, in which modality, how clean and how representative it is, and where its biases lie. For your groundtruth: how the labels are defined, where they come from, how noisy they are, and who agreed on them. Your work is only ever as trustworthy as your groundtruth is honest.

\marginnote{\newthought{Toward the system.} Fix your interfaces, the inputs and outputs and their formats, before the internals. Then motivate every design decision by the state of the art, your own experiment, or a boundary condition.}
\newthought{From data to system.} Sketch, at a high level, how you get from this data to a result: the interfaces first, then the system behind them, and how you will justify the design choices you expect to make.
