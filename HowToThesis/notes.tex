...
\begin{table}[!ht]
  \centering
  \caption{Language \& Grammar annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    ...
    wo             & Word Order              & Words appear in the wrong sequence within a sentence \\
    sv             & Subject--Verb Agreement & Subject and verb do not agree in number \\
    \bottomrule
  \end{tabular*}
\end{table}
...
\begin{table}[!ht]
  \centering
  \caption{Style \& Clarity annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
...
\begin{table}[!ht]
  \centering
  \caption{Scientific Rigor annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
    ...
    assume & Assumption       & Assumption made but not stated explicitly \\
    \bottomrule
  \end{tabular*}
\end{table}
...
\begin{table}[!ht]
  ...
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    ...
    \P & New Paragraph     & A paragraph break is needed here \\
    fwd           & Forward Reference & References material not yet introduced \\
    non-seq   & Non Sequitur      & Statement does not follow from what precedes \\
    \bottomrule
  \end{tabular*}
\end{table}
...
\begin{table}[!ht]
  \centering
  \caption{References \& Citations annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
    fmt   & Format                 & Citation not in the required style  \\
    miss & Missing Reference      & Contents lacks a proper reference \\
    inc   & Incomplete             & Not all relevant citations are included \\
    self & Excessive Self-Citation & Over-reliance on own prior work \\
    sec   & Secondary Source       & Citing a citation instead of the original \\
    \bottomrule
  \end{tabular*}
\end{table}
...
\begin{table}[!ht]
  \centering
  \caption{Figures \& Tables annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
    ...
    src   & Source Missing & Origin of figure or table not attributed \\
    res   & Low Resolution & Image quality too low for print \\
...
\begin{table}[!ht]
  \centering
  \caption{Length \& Scope annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
...
\begin{table}[!ht]
  \centering
  \caption{Technical Notation \& Equations annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
    ...
    prec & Precision      & Too many or too few significant figures \\
    eq     & Equation Error & Mathematical error in the equation \\
    dim   & Dimensionality & Dimensional inconsistency in formula \\
    \bottomrule
  \end{tabular*}
\end{table}
...
\begin{table}[!ht]
  \centering
  \caption{Format \& Layout annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
    wid     & Widow      & Single word or line stranded at top of page \\
    orp     & Orphan     & Single word or line stranded at bottom of page \\
...
\begin{table}[!ht]
  \centering
  \caption{Academic Integrity annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
    ...
    ai         & Undisclosed AI Use  & AI-generated content not declared \\
...
\begin{table}[!ht]
  \centering
  \caption{Logic \& Argumentation annotation abbreviations.}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
    \toprule
    \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
    \midrule
