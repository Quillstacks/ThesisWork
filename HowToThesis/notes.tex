...
\begin{itemize}
  \item \textbf{Present quantitative results} with appropriate statistical measures (e.g., means, standard deviations, confidence intervals).
  \item \textbf{Use tables to organize} numerical data and figures to illustrate trends, patterns, or relationships.
