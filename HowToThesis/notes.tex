...
% TODO: Add a quick structural element e.g. IMRD approach.
% TODO: Emphasize the iteration based on a quick and early "messbarmachung".
...
\newthought{Select a topic} that aligns with your interests and career goals.
...
\newthought{Manage your responsibilities} when engaging in a cooperation between industry and academia.
...
\newthought{Ensure the supervisor's} research interests and expectations align with your thesis work.
...
\newthought{Templates}, there are usually always templates provided by your institution, or Professor, make use of them.
\marginnote{
  ...
  Also for you who uses another template, but wants to find guidance on thesis structure.
  }

\marginnote{
  \newthought{DHBW Ravensburg} provides a LaTeX template as well which can be found
  \href{https://onedrive.live.com/?cid=476767771CCA9062&id=476767771CCA9062!s1b9e4e9537e5415ba4bc0b2c042de30e}{here.}
}

\newthought{Read this Guideline}, really this will take you a long way. A nice side-effect is that feedback and discussion 
rounds will be more focused on content than formatting or structure - your work and you can only benefit from that.

\newthought{Start early} and divide your work into manageable efforts, with clear artifacts. Do the same for your writing - for same page you will need a whole day. 
...
\newthought{Write in English} at all cost. This is research, you are writing to be read and to make an impact with your contribution.
Don't handicap yourself by writing in a language that is not widely understood in the scientific community. Make use of our lingua franca - English. 


\newthought{Read your Thesis}
...
\newthought{Use LaTex} to write your thesis. Personally, I can recommend Visual Studio Code combined with the extensions LaTeX Workshop (for TeX support)
and LTeX (for spell and style checking). 

\newthought{Establish a plan}, it is crucial to establish a personal schedule and workflow. 
...
\newthought{Stay organized}, keep track of your sources, notes, and drafts. Your thesis document, can help a lot in this, 
but should not be the only place where you structure, plan and document your experiments and work.

\newthought{Know your data and groundtruth} before you reach for a model. Be able to explain, in plain words, where your data comes from, how much there is, how clean and how representative it is, and where its biases lie. Do the same for your groundtruth: how the labels are defined, how noisy they are, and who agreed on them. Your results can only ever be as trustworthy as your groundtruth is honest.

\newthought{Back Up your Work}. Use version control to be able to recover your work. Back up regularly, better automatically.
...
\newthought{Constant dripping} wears away the stone. Constant progress, even if small, accumulates over time and leads to significant results.
...
\newthought{Motivation fluctuates.} This is normal. Progress is not linear, so frustration and self-doubt are part of the game. Embrace it, this is not only you.
...
\newthought{When you get stuck} there are a few strategies:
\begin{itemize}
...
\section{Brief Note on the Use of AI}
...
\marginnote{%
  \textit{"Only someone who has tried to move people with ink
  knows how heavy a single word can weigh."} John Steinbeck.\\

  \newthought{Your text has a purpose.} It is there to communicate
  the contributions you made and the work you did. So come to see
  each sentence as an asset, not as unwanted labor.
}
...
\newthought{AI usage beyond} those whitelisted needs examiner approval. Their use must be made transparent, and follow basic principles of academic integrity.

\newthought{DHBW Ravensburg specifics.} For the work I supervise, the Eigenst\"andigkeitserkl\"arung is the formality that matters: I do not ask for a tabular KI-Verzeichnis, and I do not ask for a separate Erkl\"arung zum Einsatz von KI.
...
\bigskip
\section{On the Title Page}
\newthought{The title page is the one page} whose contents your faculty prescribes rather than leaves to your taste. Copy your institution's template exactly, it carries the metadata that identifies the work. At the DHBW Ravensburg, Fakult\"at Wirtschaft, \S3.2.2 of the Richtlinien~\cite{DHBWRavensburgRichtlinien2025} requires:
\marginnote{%
  \newthought{Watch out.} No matriculation number belongs on the title page, and the date is the Abgabedatum, not a processing period. A Mustervorlage sits at the end of the Richtlinien.\\
  \newthought{Download.} Get the full Richtlinien \href{https://pages.schutera.com/references/Richtlinien_wissenschaftliches_Arbeiten_DHBW_Wirtschaft_2025-12.pdf}{here}.
}
\begin{itemize}
  \item Title and, if present, subtitle
  \item Type of work (Bachelorarbeit, Seminararbeit, etc.)
  \item University and faculty
  \item Author
  \item Degree program and Studienrichtung
  \item Kurs
  \item DHBW supervisor
  \item Dual Partner
  \item Company mentor (optional)
...
\section{On Length}
  ...
  \begin{itemize}
    ...
    \item A thesis should ideally be around 12,000–18,000 words, maximum 24,000 words.\marginnote{\newthought{DHBW rule.} StuPrO Wirtschaft \S5(2): 40 to 60 pages; figures, tables, directories, and appendices excluded; deviation needs supervisor consent.}
  \end{itemize}
...
% ----------------------------------------------------------------------
\chapter{Marks \& Annotations}

\marginnote{\newthought{Three strikes.} When the same mark appears three times, it is a clear sign that you have a recurring issue 
in your writing, so I usually stop after the third occurrence and leave it to you.}
\newthought{What the red pen really meant.}
For starters I usually do not use a red pen. But, every annotation on your draft is a message from a reader who engaged 
carefully with your work, feedback means someone spent time with your thoughts really.
The shorthand below follows conventions common across supervisors and examiners, so who am I to reinvent the wheel.

\section{Substance}
\newthought{Rethink, not retouch.} The marks in this section outrank every mark that
follows. A surface mark you answer with the pen. A substance mark you cannot: it sends
you back to the work, not the text. Expect at most a handful on an entire thesis. If you
get one, do not edit the paragraph. Reopen the experiment.

\setlength\LTleft{0pt}
\setlength\LTright{0pt}

\begin{longtable}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
  \caption{Method \& Evidence: can the reader believe this result?}\\
  \toprule
  \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
  \midrule
  \endfirsthead
  \toprule
  \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
  ...
  \bottomrule
  \endlastfoot
  base   & No Baseline         & Result reported with nothing to compare against \\
  leak   & Train-Test Leakage  & Test information leaked into training or selection \\
  abl    & Ablation Missing    & Contribution of each component never isolated \\
  fair   & Unfair Comparison   & Baseline weaker or less tuned than the proposed method \\
  conf   & Confound            & Alternative explanation for the result never ruled out \\
  mism   & Metric Mismatch     & Metric does not measure the stated objective \\
  sig    & No Significance     & Reported without variance, seeds, or error bars \\
  cherry & Cherry-Picked       & Only flattering examples or runs shown \\
  imbal  & Imbalance Ignored   & Aggregate score hides failure on rare cases \\
  kpi?   & Target Undefined    & Success threshold never set before building \\
  prov   & Provenance Unclear  & Origin, size, or modality of the data unstated \\
  reps   & Not Representative  & Data does not match the deployment domain \\
  repro  & Reproducibility Gap & Result cannot be rerun from what is written or shared \\
\end{longtable}

\begin{longtable}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
  \caption{Creativity \& Originality: is there Sch\"opfungsh\"ohe?}\\
  \toprule
  \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
  \midrule
  \endfirsthead
  ...
  \bottomrule
  \endlastfoot
  frame & Reframe          & Problem accepted as given, never reframed \\
  simpl & Simpler Path     & Simpler solution never tried or acknowledged \\
  asis  & Off the Shelf    & Standard method dropped in with no adaptation \\
  safe  & All Workhorse    & No staircase or moonshot among the objectives \\
  nov   & Novelty Unstated & Contribution over related work never made explicit \\
\end{longtable}

\begin{longtable}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
  \caption{Research Craft \& Reflection: was this done, and owned, like research?}\\
  \toprule
  \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
  \midrule
  \endfirsthead
  ...
  \bottomrule
  \endlastfoot
  over   & Overclaim                & Conclusion outruns what the result shows \\
  caus   & Causal Leap              & Correlation reported as causation \\
  null   & Buried Null              & Negative or null result hidden instead of reported \\
  tie    & Untethered Result        & Finding never tied back to the research question \\
  works  & Undefined Success        & ``Works'' asserted without defining what success means \\
  rq     & Question Unanswerable    & Question too vague for any result to settle it \\
  synth  & Listed, Not Synthesized  & Sources given in sequence, never connected \\
  gap    & Gap Not Demonstrated     & Gap announced without showing the literature leaves it open \\
  mot    & Unmotivated Decision     & Design choice tied to none of the three admissible reasons \\
  fc     & No Failure-Case Analysis & Only successes shown, failure modes unexamined \\
  lim    & Boundaries Unstated      & Scope and threats to validity never stated \\
  logic  & Logical Error            & Conclusion does not follow from premises \\
  circ   & Circular Reasoning       & Argument uses its conclusion as a premise \\
  hasty  & Hasty Generalization     & Broad claim drawn from too few cases \\
  straw  & Straw Man                & Opponent's position misrepresented to attack it \\
  contra & Self-Contradiction       & Two statements in the text contradict each other \\
\end{longtable}

\section{Surface}

\begin{longtable}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
  \caption{Structure \& Flow annotation abbreviations.}\\
  \toprule
  \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
  \midrule
  \endfirsthead
  ...
  \bottomrule
  \endlastfoot
  org   & Organization      & Logical order of ideas is unclear \\
  tr    & Transition        & Missing or weak transition between ideas \\
  fwd   & Forward Reference & References material not yet introduced \\
  verb  & Verbose           & Could be expressed in fewer words \\
  pad   & Padding           & Filler content that adds no meaning \\
  oos   & Out of Scope      & Content irrelevant to the research question \\
  short & Too Short         & Section underdeveloped; needs more content \\
  cut   & Cut               & Entire passage should be removed \\
\end{longtable}

\begin{longtable}{@{\extracolsep{\fill}}llp{0.45\linewidth}}
  \caption{Format \& Presentation annotation abbreviations.}\\
  \toprule
  \textbf{Abbr.} & \textbf{Full Term} & \textbf{What went wrong} \\
  \midrule
  \endfirsthead
  ...
  \bottomrule
  \endlastfoot
  gr          & Grammar             & Grammatical error: wrong tense, verb form, or agreement \\
  sp          & Spelling            & Word is misspelled \\
  p / punct   & Punctuation         & Wrong or missing punctuation mark \\
  awk         & Awkward             & Phrasing is unnatural or hard to parse \\
  vg / vague  & Vague               & Statement too imprecise to be meaningful \\
  wc          & Word Choice         & Wrong or imprecise word used \\
  rep         & Repetition          & Same word or idea repeated unnecessarily \\
  clich\'e    & Clich\'e            & Overused expression; avoid in academic writing \\
  def         & Define              & Term used without definition on first use \\
  cite        & Missing Citation    & Claim made without a source \\
  ev          & Evidence            & Statement lacks supporting evidence \\
  quant       & Quantify            & Assertion needs a number or measure \\
  miss        & Missing Reference   & Contents lacks a proper reference \\
  not         & Notation            & Inconsistent or undefined notation \\
  unit        & Missing Unit        & Numerical value given without a unit \\
  eq          & Equation Error      & Mathematical error in the equation \\
  cap         & Caption             & Missing, incomplete, or non-descriptive caption \\
  ref         & Not Referenced      & Figure or table not mentioned in the main text \\
  junk        & Chartjunk           & Decorative elements reduce clarity \\
  wid         & Widow               & Single word or line stranded at top of page \\
  spc         & Spacing             & Inconsistent or incorrect spacing \\
  align       & Alignment           & Text or element not properly aligned \\
  font        & Font Style          & Wrong or inconsistent font usage \\
  plag        & Plagiarism          & Text taken from source without attribution \\
  paraph      & Improper Paraphrase & Source too closely echoed without quoting \\
  ghost       & Ghost Citation      & Citation present but source never consulted \\
\end{longtable}
...
\bibliography{howtothesis_references}
